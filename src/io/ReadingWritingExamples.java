...
//        File src = new File ("C:\\Users\\skennedy\\Documents\\NetbeansProjects\\Udemy\\src\\main\\java\\lets_get_certified\\io\\ReadingWritingExamples.java"); // Windows
//        File dest = new File ("C:\\Users\\skennedy\\Documents\\NetbeansProjects\\Udemy\\src\\main\\java\\lets_get_certified\\io\\ReadingWritingExamples2.java");
        File src = new File ("/Users/seankennedy/aUdemy/Source Code/Advanced Java and Spring Boot/src/io/sample.txt"); // Mac
        File dest = new File ("/Users/seankennedy/aUdemy/Source Code/Advanced Java and Spring Boot/src/io/sample2.txt");
...
//        File src = new File ("./target/classes/lets_get_certified/io/ReadingWritingExamples.class"); // Windows
//        File dest = new File ("./target/classes/lets_get_certified/io/ReadingWritingExamples2.class");
        File src = new File ("/Users/seankennedy/aUdemy/Source Code/Advanced Java and Spring Boot/src/io/SampleImage.png"); // Mac
        File dest = new File ("/Users/seankennedy/aUdemy/Source Code/Advanced Java and Spring Boot/src/io/SampleImage2.png");
