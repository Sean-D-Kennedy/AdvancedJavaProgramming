...
NOTE: The editor copies the properties files into the correct "target" directory automatically. If you are
      copying the properties files in manually, copy them into "..\target\classes\localisation".
      If you want to edit them via the editor, then copy them into "..\src\main\java\localisation"
